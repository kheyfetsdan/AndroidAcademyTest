...
import com.example.android.androidacademytest.model.Genre
...
internal fun parseMovies(
    ...
    return jsonMovies.map { jsonMovie ->
        ...
        genres = jsonMovie.genreIds.map { id ->
            genresMap[id].orThrow { IllegalArgumentException("com.example.android.androidacademytest.model.Genre not found") }
        },
